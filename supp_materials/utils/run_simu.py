...
def run_simu_mem(walls, source, receiver,
             ...
             att=np.array([0]),res=4):
    """Run sparrowpy simulation and measure memory consumption."""
...
def run_simu(walls, source, receiver,
             ...
             att=np.array([0]),
             res=4):
    """Run sparrowpy simulation and measure runtimes."""
...
def run_simu_BRDF(
        ...
        patch_size=3,
        speed_of_sound=343.26, time_step=.002, duration=1.,
        refl_order=30,
        file_wall=None,
        file_ground=None):
    """Run radiosity simulation given BRDF files (.sofa)."""
    ...
    # find patch indices corresponding to ground and wall
    ...
    # initialize and exchange energy
    radi.init_source_energy(source)
    radi.calculate_energy_exchange(
        speed_of_sound=speed_of_sound,
        etc_time_resolution=time_step,
