...
if numba is not None:
    ...
    nusselt_integration = numba.njit(cache=True,parallel=False)(nusselt_integration)
    stokes_integration = numba.njit(cache=True,parallel=False)(stokes_integration)
    nusselt_analog = numba.njit(cache=True,parallel=False)(nusselt_analog)
    load_stokes_entries = numba.njit(cache=True,parallel=True)(load_stokes_entries)
